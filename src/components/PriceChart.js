...
const showPriceChart = (props) => {
  return (
    <div className="main-chart mb15 price-chart">
      ...
      {props.theme==='light'?<Chart options={chartOptions} series={props.priceChart.series} type='line' width='100%' height='100%' />:
      <Chart options={chartOptionsDark} series={props.priceChart.series} type='line' width='100%' height='100%' />
    }
    </div>
  )
}
