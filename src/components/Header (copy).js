...
const Notification = (props) => {
  ...
  const web3 = new Web3(
    new Web3.providers.HttpProvider("http://139.59.178.154:7545")
  );
                ...
                {orderAmount.map((obj, key) => (
                  <a href="#!" className="dropdown-item">
                    ...
                    <div className="content">
                      <p>
                        Order filled for {eval(obj.toFixed(2))} of{" "}
                        {showName[key]}
                      </p>
          ...
          <Navbar expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="navbar-nav mr-auto">
                <a className="nav-link" href="/players/mbappe">
                  Exchange
                </a>
                <NavDropdown title="Players">
                  <a className="dropdown-item" href="/players/haaland">
                    Haaland
                  </a>
                  <a className="dropdown-item" href="/players/mbappe">
                    mbappe
                  </a>
                ...
                <NavDropdown title="Others">
                  ...
                  <a className="dropdown-item" href="/ipo/mbappe">
                    Ipo
                  </a>
