...
import Token580 from '../tokens/Token580.json'
import Exchange580 from '../exchanges/Exchange580.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token580.abi, Token580.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange580.abi, Exchange580.networks[networkId].address)
